...
Once the name and the test-key to silicon iam is given, the dm would also generate a test key, this test key can be used by any one to perform any action in silicon-remind. 
